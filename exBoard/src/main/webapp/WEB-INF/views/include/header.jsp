...
<script src="/resources/bower_components/jquery-ui/jquery-ui.min.js"></script>
  ...
  <!-- include textHandlebars -->
    <jsp:include page="/resources/controll/jsp/textHandlebars.jsp">
  <jsp:param name="token" value="<%=token%>" />
  </jsp:include>
    <!-- success/failFunction -->
 ...
 <!-- editMenu Style -->
  <jsp:include page="/resources/Modals/Modal.jsp">
  	<jsp:param name="token" value="<%=token%>" />
  </jsp:include>
  ...
  <![endif]-->
  <jsp:include page="/resources/kepEditor/menuStyle.jsp">
  <jsp:param name="token" value="<%=token%>" />
  </jsp:include> 
...
<div class="wrapper" style="background-image: z-index:999;">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>게시판</b>예제</span>
    </a>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="header">MAIN NAVIGATION</li>
    	  <li>
          <a href="/index">
           <i class="fa fa-home" aria-hidden="true"></i> <span>Index로</span>
          </a>
        </li>
        ...
        <li>
          <a href="/board/list">
            <i class="fa fa-calendar"></i> <span>List로</span>
        ...
        <li><a href="/board/registWithEditor"><i class="fa fa-book"></i> <span>글쓰러가기</span></a></li>
